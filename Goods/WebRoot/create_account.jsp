...
<html>
<head>
	<title>RobotTech | Create account</title>
        ...
        <div class="menu">
           <ul id="nav">
               ...
               <li><a class="hsubs" href="productServlet">Products</a>
                ...
                <li class="active"><a class="hsubs" href="create_account.jsp">Create account</a> &lt; </li>
...
<div class="image-slider">
			      ...
			      <li><img src="images/createbackground.jpg" alt=""></li>
			    
	</div>

			
			<form action="<c:url value='/userServlet?method=add'/>" method="post">
  				...
  				<br><p align="center"><font size="+2"color="black">Password: </font><input type="text" placeholder="Password" maxlength="50" name="password" style="height:30px;width: 150px " 
  				/></p>
		
  				
  				<br><p align="center">You can see your password when you creating your account.</p>
  				<br><p align="center"><font color="red">${message }</font></p>
  				<br><p align="center"><font color="black"></font><input type="submit" style="width:100px;height:40px;" value="Create now !"  /></p>
