...
<html>
<head>
	<title>Successfully buy | RobotTech</title>
	...
	<div class="header">
        ...
        <div class="menu">
           <ul id="nav">
                ...
                <li class="active"><a class="hsubs" href="artists.html">Products</a>
                	<ul class="subs">
                ...
                <li><a class="hsubs" href="favorites.html">Sign in</a>
...
<div class="clear"></div>
	...
	<div class="image-slider">
			      ...
			      <li><img src="images/buy.jpg" alt=""></li>
    </div>
	
	<br><br>
	<h3 align="center"><a href="productServlet"><font color = gray size="+2"> Press here to get homepage...</font></a></h3>
	<br><br>
