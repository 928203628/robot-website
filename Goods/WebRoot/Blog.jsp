...
<html>
<head>
	<title>The Free Gallery-Blog Website Template | Blog :: w3layouts</title>
...
<div class="wrap"> 
	<div class="header">
		<div class="logo">
				<a href="productServlet"><img src="images/logo.png" alt=""  title="logo"/></a>
		</div>
        <div class="menu">
           <ul id="nav">
                <li ><a href="productServlet">Home</a></li>
                <li ><a class="hsubs" href="artists.html">Artists</a>
                    <ul class="subs">
                        <li><a href="artists.html">Artists 01</a></li>
                        <li><a href="artists.html">Artists 01</a></li>
                   		 <li><a href="artists.html">Artists 01</a></li>
                    </ul>
                </li>
                <li><a class="hsubs" href="favorites.html">Favourites</a>
                    <ul class="subs">
                           <li><a href="favorites.html">Favorites 01</a></li>
                      <li><a href="favorites.html">Favorites 02</a></li>
                        <li><a href="favorites.html">Favorites 03</a></li>
                   </ul>
                </li>
...
<div class="main">
		<div class="artists">
			<div class="blog">
		<div class="grid">
			<h4><a>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</a></h4>
		...
		<div class="grid">
			<h4><a>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</a></h4>
			<h5>May 5th, 2013 , Posted by <a href="index.html">k. Jackson</a></h5>
			<p>"On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to distinguish. In a free hour, </p>
		...
		<div class="grid">
			<h4><a>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</a></h4>
			<h5>April 20th, 2013 , Posted by <a href="index.html">J.Thomas</a></h5>
			<p>"On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to distinguish. In a free hour, </p>
...
<div class="f-grid">
	...
	<nav>	
		<ul>
			...
			<li><a href=""> Premimum Gallerys</a></li>
...
<div class="ftr-bg">
	<div class="wrap"> 
		<div class="footer">
				<p class="w3-link"><span>© All rights Reserved | Designed by&nbsp; <a href="http://w3layouts.com/"> W3Layouts</a></span></p>
		</div>
	</div>
</div>
</body>
